...
(define make-let*-exp (lambda (bindings body) 'your-implementation-here))

; Purpose: let* type predicate
; Signature: let*-exp?(x)
; Type: *Write the type here*
(define let*-exp? (lambda (x) 'your-implementation-here))

; Purpose: An accessor for the bindings of a let* expression
; Signature: let*-exp->bindings(x)
; Type: *Write the type here*
(define let*-exp->bindings (lambda (x) 'your-implementation-here))

; Purpose: An accessor for the body of a let* expression
; Signature: let*-exp->body(x)
; Type: *Write the type here*
(define let*-exp->body (lambda (x) 'your-implementation-here))
